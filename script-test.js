...
//     generateMockQuestions(tier, subject);
//     startTimer();
//     renderQuizUI();
// }
...
// function generateMockQuestions(tier, subject) {
//     questions = [];
//     for (let i = 1; i <= 30; i++) {
//         questions.push({
//             q: `Question ${i} for ${tier} ${subject}`,
//             options: ['A', 'B', 'C', 'D'],
//             correct: 0
//         });
//     }
...
//     mainBox.innerHTML = `
//         <div class="heading"><h1>QUESTMASTER ACADEMIC</h1></div>
//         <div id="quiz-container" style="padding: 20px;">
//             <p id="timer" style="color: #34E89E;">Time Left: ${Math.floor(timeLeft / 60)}:${timeLeft % 60}</p>
//             <h3 id="question-text">${questions[currentQuestionIndex].q}</h3>
//             <div id="options-box" style="margin-top: 15px;">
//                 ${questions[currentQuestionIndex].options.map((opt, i) => `
//                     <button onclick="checkAnswer(${i})" style="display: block; margin: 5px; padding: 10px; width: 200px; cursor: pointer;">${opt}</button>
//                 `).join('')}
//             </div>
//         </div>
//     `;
...
//     localStorage.setItem('qp_total', newTotal);
    
//     alert(`Quiz Finished! You earned ${score} points.`);
//     location.reload();
// }

// function updateUI() {
//     const total = parseInt(localStorage.getItem('qp_total') || 0);
//     totalPointsDisplay.innerText = `Total Points ${total}`;
    
//     let caliber = "Beginner";
//     if (total > 2000) caliber = "Intermediate";
//     if (total > 5000) caliber = "Expert";
//     if (total >= 10000) caliber = "Grand Master";
    
//     caliberDisplay.innerText = `Caliber ${caliber}`;
...
//     const caliber = caliberDisplay.innerText;
//     const printWindow = window.open('', '_blank');
//     printWindow.document.write(`
//         <html>
//             <head><title>Progress Card</title></head>
//             <body style="font-family: sans-serif; text-align: center; padding: 50px;">
//                 <h1>QuestMaster Academic Progress Card</h1>
//                 <hr>
//                 <h2>Total Points: ${total}</h2>
//                 <h2>Current Status: ${caliber}</h2>
//                 <p>Keep learning and reaching for Grand Master!</p>
...
// printBtn.innerText = "PRINT PROGRESS";
// printBtn.className = "button-start";
// printBtn.style.marginLeft = "10px";
// printBtn.onclick = printProgressCard;
// document.querySelector('.progress-section').appendChild(printBtn);
...
//             { q: "Which number comes after 19?", options: ["18", "20", "21", "22"], correct: 1 }
//         ],
//         "Physics": [
...
//         if (timerElem) timerElem.innerText = `Time Left: ${mins}:${secs < 10 ? '0' : ''}${secs}`;
...
//             <h2 id="question-text" style="margin-bottom: 20px;">${questions[currentQuestionIndex].q}</h2>
//             <div id="options-box">
//                 ${questions[currentQuestionIndex].options.map((opt, i) => `
//                     <button class="button-start" onclick="checkAnswer(${i})" 
//                     style="display: block; width: 100%; margin: 10px 0; text-align: center; height: 40px;">
//                     ${opt}
//                     </button>
//                 `).join('')}
//             </div>
...
//             <body style="font-family: Arial; text-align: center; border: 5px solid #34E89E; padding: 50px;">
...
//                 <p style="font-size: 24px;">Current Caliber: <strong>${caliber}</strong></p>
//                 <br><br>
    ...
    mainBox.innerHTML = `
        ...
        <div id="quiz-container" style="padding: 20px;">
            ...
            <div id="options-box">
                ${questions[currentQuestionIndex].options.map((opt, i) => `
                    <button class="button-start" onclick="checkAnswer(${i})" 
                    style="display: block; width: 100%; margin: 10px 0; text-align: center; height: 40px; padding: 0 10px;">
                    ${opt}
                    </button>
                `).join('')}
            </div>
